...
import { buttonOutlinedThird } from '~/components/atoms/Button/Button.stories.content'

export const headline = 'Headline 2'
export const subline = 'Subline 3'
export const buttons = [buttonOutlinedThird]
export const richtext = smallText.richtext
export const icon = 'contact_support'
