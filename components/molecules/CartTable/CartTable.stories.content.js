        ...
        variationValues: [
          {
            ...
            displayValue: 'Für Anwendungen mit nicht korrosiven Gasen',
            selectable: true,
            selected: true,
        ...
        variationValues: [
          {
            ...
            displayValue: 'DE 100 V AC, 50 Hz // 95 – 105 V AC (±10 %), 60 Hz',
            selectable: true,
            selected: true,
            value: 'DE 100 V AC, 50 Hz // 95 – 105 V AC (±10 %), 60 Hz',
          },
          {
            automaticallySelected: false,
            displayValue: 'DE 105 V AC, 50 Hz // 115 – 125 V AC (±10 %), 60 Hz',
            selectable: true,
            selected: false,
            value: 'DE 105 V AC, 50 Hz // 115 – 125 V AC (±10 %), 60 Hz',
          },
        ],
      },
    ],
